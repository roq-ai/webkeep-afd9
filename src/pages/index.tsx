  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Secure your digital world with WebKeep - your trusted partner for safely storing all your access details across various sites and platforms."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1496368077930-c1e31b4e5b44?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzZWN1cml0eXxlbnwwfHx8fDE2OTAyMjIyODF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Secure your digital world with WebKeep - your trusted partner for safely storing all your access details across various sites and platforms.`}
            </Text>
            <Box
